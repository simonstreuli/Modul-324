...
4. Trigger CI (Push / PR). Zeige im GitHub Actions Lauf, dass `lint-and-test` erfolgreich durchläuft und Coverage hochgeladen wird. Link zur Pages‑Seite (Coverage) = https://simonstreuli.github.io/Modul-324/
